...
class TypographyScale {
 ...
 static TextTheme getMobileScale(BuildContext context) {
   ...
   return TextTheme(
     headlineLarge: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 28 * textScaler.scale(28),
       fontWeight: FontWeight.w700,
       height: 1.15,
     ),
     headlineMedium: TextStyle(
     ...
     titleMedium: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 14 * textScaler.scale(14),
       fontWeight: FontWeight.w500,
       height: 1.3,
     ),
     titleSmall: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 12 * textScaler.scale(12),
       fontWeight: FontWeight.w500,
       height: 1.3,
     ),
     bodyLarge: TextStyle(
     ...
     bodySmall: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 10 * textScaler.scale(10),
       fontWeight: FontWeight.w400,
       height: 1.3,
     ),
     displayLarge: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 16 * textScaler.scale(16),
       fontWeight: FontWeight.w500,
       height: 1.2,
     ),
     displayMedium: TextStyle(
 ...
 static TextTheme getTabletScale(BuildContext context) {
   ...
   return TextTheme(
     headlineLarge: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 32 * textScaler.scale(14),
       fontWeight: FontWeight.w700,
       height: 1.2,
     ),
     headlineMedium: TextStyle(
     ...
     titleLarge: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 22 * textScaler.scale(14),
       fontWeight: FontWeight.w500,
       height: 1.3,
     ),
     titleMedium: TextStyle(
 ...
 static TextTheme getDesktopScale(BuildContext context) {
   ...
   return TextTheme(
     headlineLarge: TextStyle(
       fontFamily: 'Lufga',
       fontSize: 36 * textScaler.scale(14),
       fontWeight: FontWeight.w700,
       height: 1.2,
     ),
     headlineMedium: TextStyle(
